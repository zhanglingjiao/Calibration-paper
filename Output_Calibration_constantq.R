...
source("chi2 statistic_q.R")
source("Calibration statistic replication function_q.R")
...
fit20=replik_calib_q(n, nt, nv,ntest, nrep, Betay=Beta4, random=T, c, cbeta, iter, tol, seed1, alpha=Beta4, vv=vv2, delta=0.1,mis=F,mc=mc1,psd)
mean(fit20$mtstat)
mean(fit20$mpvalue<0.05)
fit20$qc
fit20$casetable

fit21=replik_calib_q(n, nt, nv,ntest, nrep, Betay=Beta4, random=T, c, cbeta, iter, tol, seed1, alpha=Beta4, vv=vv2, delta=0.1,mis=T,mc=mc1,psd)
mean(fit21$mtstat)
mean(fit21$mpvalue<0.05)
fit21$qc
fit21$casetable

fit22=replik_calib_q(n, nt, nv,ntest, nrep, Betay=Beta4, random=T, c, cbeta, iter, tol, seed1, alpha=Beta4, vv=vv2, delta=0.1,mis=T,mc=mc2,psd)
mean(fit22$mtstat)
mean(fit22$mpvalue<0.05)
fit22$qc
fit22$casetable

fit23=replik_calib_q(n, nt, nv,ntest, nrep, Betay=Beta4, random=T, c, cbeta, iter, tol, seed1, alpha=Beta4, vv=vv2, delta=0.1,mis=T,mc=mc3,psd)
mean(fit23$mtstat)
