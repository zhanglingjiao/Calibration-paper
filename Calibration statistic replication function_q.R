...
replik_calib_q=function(n, nt, nv,ntest, nrep, Betay, random, c, cbeta, iter, tol, seed1, alpha, vv, delta,mis,mc,psd){
  ...
  for (i in 1:nrep){
    ...
    q=rnorm(1,mean=prevalence,sd=psd*prevalence)
    Vq=(psd*prevalence)^2
...
#calibration
    calibration0=calib_q(train, mBetay, coef1, cov1, bbeta, vv, delta,q,Vq)
